// Shared HTML builder for The IRIS Dispatch newsletter.
// Used by both the manual admin compose route and the fully-automated send cron.

export function buildIrisEmailHtml(params: {
  edition: number
  subject: string
  intro: string
  whatShipped: string
