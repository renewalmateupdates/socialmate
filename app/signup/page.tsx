      ...
      <div className="min-h-dvh bg-theme flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="bg-surface border border-theme rounded-3xl p-10 w-full max-w-md text-center">
            ...
            {refCode && (
              <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-2xl p-4 mb-6 text-left">
                <p className="text-xs font-bold text-green-700 dark:text-green-400 mb-1">🎁 Referral applied</p>
            ...
            <div className="bg-surface border border-theme rounded-3xl p-8">
              ...
              {refCode && (
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800 rounded-xl px-4 py-3 mb-4">
                  <p className="text-xs font-bold text-green-700 dark:text-green-400">🎁 Referral code applied: <span className="uppercase">{refCode}</span></p>
                  <p className="text-xs text-green-600 dark:text-green-500 mt-0.5">You'll both earn 25 bonus AI credits after your first post.</p>
                </div>
              )}
