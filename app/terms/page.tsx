      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <section>
            ...
            <p>By creating an account, accessing, or using SocialMate and its related services (collectively, the "Service"), you ("User", "you") agree to be legally bound by these Terms of Service ("Terms"), our <Link href="/privacy" className="font-semibold underline text-gray-900 dark:text-gray-100">Privacy Policy</Link>, and any additional policies incorporated herein. These Terms constitute a binding legal agreement between you and Gilgamesh Enterprise LLC, a Wyoming limited liability company ("Company", "we", "us", "our").</p>
