  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          <Link href="/" className="text-sm font-bold text-gray-400 hover:text-black transition-all">← Back to SocialMate</Link>
        </div>

        <h1 className="text-4xl font-extrabold tracking-tight mb-2">Terms of Service</h1>
        <p className="text-sm text-gray-400 mb-12">Last updated: March 14, 2026 · Gilgamesh Enterprise LLC</p>
        ...
        <div className="space-y-10 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">5. Subscription and billing</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">6. Refund policy</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">8. AI features</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">9. Connected platforms</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">10. Affiliate and referral program</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">11. Disclaimers and limitation of liability</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">15. Contact</h2>
