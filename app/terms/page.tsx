      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="space-y-10 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <section>
            ...
            <p className="mt-2 text-xs bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg px-3 py-2 text-amber-800 dark:text-amber-300 font-medium flex items-start gap-1.5">
              <AlertTriangle size={13} strokeWidth={2} className="shrink-0 mt-0.5" />
              <span>Automated and scheduled posting may trigger spam detection on some platforms. SocialMate is not responsible for account suspensions or bans resulting from your posting activity.</span>
            </p>
