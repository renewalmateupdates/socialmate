...
const TIERS = [
  ...
  },
  {
    ...
    badgeStyle: 'bg-gray-700 text-gray-300',
    ctaStyle: 'border-2 border-gray-500 text-gray-300 hover:border-white hover:text-white',
    ctaLabel: 'Contact Us',
    ctaHref: '/enterprise',
    features: [
      'Unlimited campaigns',
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <section id="pricing" className="mb-20">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-gray-400 max-w-xl mx-auto mt-3">
              Real limits at every tier so we stay sustainable. Hit the ceiling? Scale up or go Enterprise.
            </p>
          </div>
            ...
            {TIERS.map(tier => (
              <div key={tier.name} className={`rounded-2xl p-6 flex flex-col ${tier.cardBg} ${tier.border}`}>
                ...
                <div className="flex items-end gap-1 mb-1">
                  ...
                  {tier.price.startsWith('$') && <span className="text-xs text-gray-500 mb-1.5">/mo</span>}
                </div>
