    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-gray max-w-none space-y-10 text-sm leading-relaxed text-gray-700">
          ...
          <section>
            <h2 className="text-lg font-bold text-gray-900 mb-3">2. What we collect</h2>
            <p className="font-semibold text-gray-900 mb-2">Information you provide directly:</p>
            ...
            <p className="font-semibold text-gray-900 mb-2">Information collected automatically:</p>
            <ul className="list-disc pl-5 space-y-1 mb-4">
            ...
            <p className="font-semibold text-gray-900 mb-2">Information from third parties:</p>
