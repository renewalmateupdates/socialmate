      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-gray-900 border-2 border-gray-700 rounded-2xl p-6">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-2">TikTok Native Scheduler (TikTok Studio)</p>
            <p className="font-extrabold text-lg mb-2 text-white">TikTok-only, no cross-platform posting</p>
        ...
        {/* WHY */}
        <div className="mb-12">
          <h2 className="text-xl font-extrabold tracking-tight mb-6 text-white">Why TikTok creators add SocialMate</h2>
