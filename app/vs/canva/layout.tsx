...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Canva Pro is $15/mo for a design tool with bolt-on scheduling. SocialMate is $8/mo for a full Creator OS — Discord, Telegram, Bluesky, SOMA, Enki, 20+ AI tools.",
