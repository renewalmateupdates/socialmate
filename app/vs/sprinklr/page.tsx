...
const COMPARISON = [
  ...
  { feature: 'AI writing tools',          sprinklr: 'Enterprise AI suite',           socialmate: '15+ tools included free'  },
  { feature: 'AI credits free tier',      sprinklr: 'N/A (no free plan)',            socialmate: '50/month free'           },
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-panel border-2 border-edge rounded-2xl p-6">
            <p className="text-xs font-bold text-ink-body uppercase tracking-wide mb-2">Sprinklr</p>
            <p className="font-extrabold text-lg mb-2 text-ink-high">Enterprise powerhouse, priced to match</p>
          ...
          <div className="overflow-x-auto"><div className="bg-panel border border-edge rounded-2xl overflow-hidden min-w-[480px]">
            ...
            {COMPARISON.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 px-5 py-3.5 text-sm border-t border-edge border-edge ${i % 2 === 0 ? 'bg-panel' : 'bg-raised bg-raised'}`}>
                ...
                <span className="text-xs text-ink-muted">{row.sprinklr}</span>
        ...
        {/* WHY SWITCH */}
        <div className="mb-12">
          <h2 className="text-xl font-extrabold tracking-tight mb-6 text-ink-high">Why creators choose SocialMate over Sprinklr</h2>
        ...
        <div className="bg-void text-ink-high rounded-2xl p-8 text-center">
          ...
          <p className="text-ink-body text-sm mb-6 max-w-lg mx-auto">
            SocialMate is free forever — bulk scheduling, 15+ AI tools, 7 platforms, no enterprise contract. No credit card required.
          </p>
