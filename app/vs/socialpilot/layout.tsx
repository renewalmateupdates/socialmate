...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'SocialPilot calls itself affordable but has zero free tier. SocialMate is genuinely free — no credit card, 250 posts/month, 15+ AI tools, and alternative platform support.',
