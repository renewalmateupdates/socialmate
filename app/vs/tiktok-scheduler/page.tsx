      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-panel border-2 border-edge rounded-2xl p-6">
            <p className="text-xs font-bold text-ink-body uppercase tracking-wide mb-2">TikTok Native Scheduler</p>
            <p className="font-extrabold text-lg mb-2 text-ink-high">Free TikTok-only scheduling</p>
        ...
        <div className="mb-12">
          <h2 className="text-xl font-extrabold tracking-tight mb-6 text-ink-high">Why TikTok creators need more than TikTok Studio</h2>
