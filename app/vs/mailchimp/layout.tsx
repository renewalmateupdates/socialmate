...
export const metadata: Metadata = {
  ...
  description: "Mailchimp is an email marketing tool that starts at $13/month. SocialMate is a dedicated social media scheduler for 7 platforms — free to start, $8/month Pro. No email list required.",
  openGraph: {
