...
const COMPARISON = [
  ...
  { feature: 'Platforms supported',    onlypult: '12 (paid)',               socialmate: '16 (free)'               },
  { feature: 'Team seats',             onlypult: '1 on Start plan',         socialmate: '2 seats free'            },
  { feature: 'AI writing tools',       onlypult: '❌ No AI tools',          socialmate: '12 tools free'           },
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="border-2 border-orange-200 bg-orange-50 rounded-2xl p-6 text-center">
            <p className="text-xs font-bold text-orange-400 uppercase tracking-widest mb-2">Onlypult</p>
            <p className="text-3xl font-extrabold text-orange-600 mb-1">$25/month</p>
            <p className="text-xs text-orange-400">3 profiles · No AI tools · No free plan</p>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl overflow-hidden">
            <div className="grid grid-cols-3 bg-gray-50 dark:bg-gray-700 border-b border-gray-100 dark:border-gray-600 px-5 py-3">
              ...
              <span className="text-xs font-bold text-gray-400 uppercase tracking-wide text-center">Onlypult</span>
            ...
            {COMPARISON.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 px-5 py-3 items-center border-b border-gray-50 dark:border-gray-700 last:border-0 ${i % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50/30 dark:bg-gray-750'}`}>
                ...
                <span className="text-xs text-gray-400 dark:text-gray-500 text-center">{row.onlypult}</span>
