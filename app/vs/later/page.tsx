...
const COMPARISON = [
  ...
  { feature: 'AI credits',            later: 'Limited on paid',        socialmate: '50/month free'        },
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          <h1 className="text-4xl font-extrabold tracking-tight mb-4">SocialMate vs Later (2026)</h1>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
            ...
            {COMPARISON.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 px-5 py-3 items-center border-b border-gray-50 last:border-0 ${i % 2 === 0 ? 'bg-white' : 'bg-gray-50/30'}`}>
                ...
                <span className="text-xs text-gray-400 text-center">{row.later}</span>
        ...
        <div className="mb-12 bg-gray-50 rounded-2xl p-6">
          <h2 className="text-xl font-extrabold tracking-tight mb-4">When Later makes sense</h2>
