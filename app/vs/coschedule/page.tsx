...
const COMPARISON = [
  ...
  { feature: 'AI writing tools',          coschedule: 'AI Mia (paid)',                socialmate: '15+ tools included'       },
  { feature: 'AI credits free tier',      coschedule: '❌ None',                       socialmate: '50/month free'            },
...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Yes. The free tier includes 100 posts/month, auto-publishing, 50 AI credits/month, bulk scheduling, link in bio, hashtag manager, competitor tracking, RSS import, and evergreen recycling. No credit card required and no manual-posting restrictions.',
  },
]
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-panel border-2 border-edge rounded-2xl p-6">
            <p className="text-xs font-bold text-ink-body uppercase tracking-wide mb-2">CoSchedule</p>
            <p className="font-extrabold text-lg mb-2 text-ink-high">Editorial-heavy, free tier is barely functional</p>
          ...
          <div className="overflow-x-auto"><div className="bg-panel border border-edge rounded-2xl overflow-hidden min-w-[480px]">
            ...
            {COMPARISON.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 px-5 py-3.5 text-sm border-t border-edge border-edge ${i % 2 === 0 ? 'bg-panel' : 'bg-raised bg-raised'}`}>
                ...
                <span className="text-xs text-ink-muted">{row.coschedule}</span>
        ...
        {/* WHY SWITCH */}
        <div className="mb-12">
          <h2 className="text-xl font-extrabold tracking-tight mb-6 text-ink-high">Why people switch from CoSchedule</h2>
