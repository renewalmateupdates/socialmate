      ...
      <footer className="border-t border-gray-100 dark:border-gray-800 py-8">
        <div className="max-w-5xl mx-auto px-6 flex items-center justify-between flex-wrap gap-4">
          ...
          <div className="flex items-center gap-6 text-xs text-gray-400 dark:text-gray-500">
            ...
            <Link href="/vs/nuelink" className="hover:text-black dark:hover:text-white transition-colors">vs Nuelink</Link>
            <Link href="/vs/iconosquare" className="hover:text-black dark:hover:text-white transition-colors">vs Iconosquare</Link>
