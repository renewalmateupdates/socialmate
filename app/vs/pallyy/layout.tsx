...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Pallyy free plan caps at 15 posts/month and paid plans charge per social set. SocialMate is free forever with 100 posts a month and flat pricing.',
