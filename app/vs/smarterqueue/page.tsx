...
const COMPARISON = [
  ...
  { feature: 'Client workspaces',      smarterqueue: 'Agency plan ($82/mo)', socialmate: 'Pro+: from $8/mo'        },
]
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-violet/10 border border-violet/40 text-violet text-xs font-bold px-4 py-2 rounded-full mb-6">
            <Recycle size={13} strokeWidth={2} /> SmarterQueue specializes in evergreen recycling — SocialMate has that too, for free
          </div>
