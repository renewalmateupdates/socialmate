      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
          <div className="bg-gray-900 border-2 border-gray-700 rounded-2xl p-6">
            <p className="text-xs font-bold text-gray-400 uppercase tracking-wide mb-2">beehiiv</p>
            <p className="font-extrabold text-lg mb-2 text-white">Great newsletter tool. Not a social scheduler.</p>
          ...
          <div className="overflow-x-auto"><div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden min-w-[480px]">
            ...
            {COMPARISON.map((row, i) => (
              <div key={i} className={`grid grid-cols-3 px-5 py-3.5 text-sm border-t border-gray-800 ${i % 2 === 0 ? 'bg-gray-900' : 'bg-gray-800/30'}`}>
                ...
                <span className="text-xs text-gray-400">{row.beehiiv}</span>
        ...
        <div className="mb-12">
          <h2 className="text-xl font-extrabold tracking-tight mb-6 text-white">Build your audience on social first, then monetize with a newsletter</h2>
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                desc: "beehiiv's Scale plan costs $42/month. SocialMate's free plan covers unlimited posting across 7 platforms, 75 AI credits/month, bulk scheduling, and link in bio. If you are just getting started, start with what is free.",
              },
              {
                n: '3',
