...
const COMPARISON = [
  ...
  { feature: 'Client workspaces',      oktopost: 'Enterprise only',          socialmate: 'Pro+: from $8/mo'        },
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-amber/10 border border-amber text-amber text-xs font-bold px-4 py-2 rounded-full mb-6">
            <Building2 size={13} strokeWidth={2} /> Oktopost is enterprise-only — $500+/month, no free plan
          </div>
        ...
        <div className="mb-12 bg-raised rounded-2xl p-6">
          ...
          <p className="text-sm text-ink-muted leading-relaxed">
            If you searched &#34;Oktopost alternative&#34; because $500/month felt steep, SocialMate is the answer. Start free and scale to $29/month for an Agency account.
          </p>
        </div>
