...
const COMPARISON = [
  ...
  { feature: 'Client workspaces',      postcron: 'Agency plan ($79/mo)',    socialmate: 'Pro+: from $8/mo'        },
      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-amber/10 border border-amber text-amber text-xs font-bold px-4 py-2 rounded-full mb-6">
            <DollarSign size={13} strokeWidth={2} /> Postcron starts at $8/month — no free plan, no AI tools, adds watermarks
          </div>
