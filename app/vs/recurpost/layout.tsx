...
export const metadata: Metadata = {
  ...
  description: 'RecurPost free plan: 3 social accounts and a 100-post lifetime cap. SocialMate is free forever with 250 posts a month, no account cap, and Discord/Bluesky/Telegram/Mastodon included.',
  openGraph: {
