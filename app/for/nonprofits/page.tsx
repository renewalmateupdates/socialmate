  ...
  return (
    <PublicLayout>
      ...
      <section className="bg-black text-white py-24 px-6 text-center">
        <p className="text-xs font-bold text-rose-400 uppercase tracking-widest mb-4">Built for nonprofits &amp; community organizations</p>
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight max-w-3xl mx-auto mb-6">
          ...
          <span className="text-rose-400">that doesn&apos;t require a budget.</span>
        </h1>
        <p className="text-gray-300 max-w-xl mx-auto text-base leading-relaxed mb-8">
          The free social media tool for nonprofits and community organizations.
          Post to Discord and Telegram where your community actually lives, let AI write
          your cause-based content, and stay consistent — all without spending a dollar.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
          ...
          <Link href="/discount"
            ...
            See nonprofit discount
          </Link>
        </div>
        <p className="text-gray-500 text-xs mt-4">Free forever · No credit card · NONPROFIT50 code = 50% off Pro</p>
      </section>
      ...
      <section className="bg-gray-950 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-center text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">The nonprofit social media problem</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-center mb-12">
            Big mission, zero marketing budget.<br />Every tool wants $99/month.
          </h2>
            ...
            {PAIN_POINTS.map((p, i) => (
              <div key={i} className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
                ...
                <div className="bg-rose-950/40 border border-rose-800/50 rounded-2xl p-5">
                  <p className="text-xs text-rose-300 font-bold uppercase tracking-wide mb-2">With SocialMate</p>
      ...
      <section className="bg-black text-white py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-xs font-bold text-rose-400 uppercase tracking-widest mb-3">What you get</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold text-center mb-3">
            How SocialMate helps nonprofits reach their community.
          </h2>
          <p className="text-center text-gray-400 text-sm mb-12 max-w-xl mx-auto">
            Most features are on the free plan. Use code NONPROFIT50 for 50% off Pro.
          </p>
      ...
      <section className="bg-gray-950 text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">Where your community lives</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">7 platforms. Discord and Telegram included.</h2>
      ...
      <section className="bg-black text-white py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">Free forever. $5/month if you want more. 50% off with NONPROFIT50.</h2>
          <p className="text-gray-400 text-sm mb-12">No tricks. No mandatory upgrades. No platform that punishes you for having no budget.</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            {PRICING.map((tier) => (
              <div key={tier.plan}
                ...
                {tier.highlight && (
                  <p className="text-xs font-bold text-rose-300 uppercase tracking-widest mb-3">Most popular</p>
                )}
          ...
          <p className="text-gray-500 text-xs mt-6">No credit card required for the free plan. Cancel anytime on paid plans.</p>
        </div>
      </section>
      ...
      <section className="bg-gray-950 text-white py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-center mb-12">Nonprofit FAQ</h2>
      ...
      <section className="bg-gradient-to-b from-rose-950 to-black text-white py-20 px-6 text-center">
        <h2 className="text-2xl sm:text-3xl font-extrabold mb-4">
          Your cause deserves to be heard.<br />Without breaking the budget.
        </h2>
        <p className="text-gray-400 text-sm mb-8 max-w-md mx-auto">
          Start free today. No credit card, no trial, no expiration.
          And when you upgrade to Pro, 2% goes back to charity.
        </p>
        <Link href="/signup"
          className="inline-block bg-rose-500 hover:bg-rose-400 text-white font-bold px-10 py-4 rounded-xl text-sm transition-all">
          Create free account →
        </Link>
        <p className="text-gray-600 text-xs mt-4">No credit card · Free forever · NONPROFIT50 for 50% off Pro</p>
      </section>
