...
const FAQ = [
  ...
  },
  {
    ...
    a: "The Agency plan ($29/mo) gives you 5 client workspaces, 15 seats, and client approval workflows. Manage each location in its own workspace with separate content calendars.",
  },
]
  ...
  return (
    <PublicLayout>
      ...
      <section className="text-ink-high py-24 px-6 text-center">
        <p className="text-xs font-bold text-amber uppercase tracking-widest mb-4">{t('for_restaurants.eyebrow')}</p>
        <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-tight max-w-3xl mx-auto mb-6">
          ...
          <span className="text-amber">{t('for_restaurants.hero_title_2')}</span>
        </h1>
        ...
        <p className="text-ink-muted text-xs mt-4">{t('for_restaurants.hero_note')}</p>
      </section>

      {/* ─── PAIN POINTS ─── */}
      <section className="text-ink-high py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <p className="text-center text-xs font-bold text-ink-muted uppercase tracking-widest mb-3">{t('for_restaurants.pain_eyebrow')}</p>
            ...
            {PAIN_POINTS.map((p, i) => (
              <div key={i} className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-stretch">
                <div className="bg-panel border border-edge rounded-2xl p-5">
                  <p className="text-xs text-alert font-bold uppercase tracking-wide mb-2">{t('for_restaurants.pain_before_label')}</p>
      ...
      <section className="text-ink-high py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <p className="text-center text-xs font-bold text-amber uppercase tracking-widest mb-3">{t('for_restaurants.features_eyebrow')}</p>
      ...
      <section className="text-ink-high py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs font-bold text-ink-muted uppercase tracking-widest mb-3">{t('for_restaurants.platforms_eyebrow')}</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">{t('for_restaurants.platforms_title')}</h2>
          <p className="text-ink-body text-sm mb-8">{t('for_restaurants.platforms_desc')}</p>
          ...
          <h3 className="text-base font-extrabold text-ink-body mb-4">{t('for_restaurants.platforms_coming_title')}</h3>
          <p className="text-ink-muted text-xs mb-6 max-w-md mx-auto">
            Instagram and Facebook are on the active roadmap. See the full{' '}
            <Link href="/roadmap" className="text-amber hover:text-amber underline">roadmap</Link> for status.
          </p>
      ...
      <section className="text-ink-high py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xs font-bold text-ink-muted uppercase tracking-widest mb-3">{t('for_restaurants.pricing_eyebrow')}</p>
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">{t('for_restaurants.pricing_title')}</h2>
          <p className="text-ink-body text-sm mb-12">{t('for_restaurants.pricing_desc')}</p>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            {PRICING.map((tier) => (
              <div key={tier.plan}
                ...
                {tier.highlight && (
                  <p className="text-xs font-bold text-amber uppercase tracking-widest mb-3">{t('for_restaurants.pricing_most_popular')}</p>
                )}
          ...
          <p className="text-ink-muted text-xs">{t('for_restaurants.pricing_note')}</p>
        </div>
      </section>
      ...
      <section className="text-ink-high py-20 px-6">
        <div className="max-w-3xl mx-auto">
          <p className="text-center text-xs font-bold text-ink-muted uppercase tracking-widest mb-3">{t('for_restaurants.faq_eyebrow')}</p>
      ...
      {/* ─── BOTTOM CTA ─── */}
      <section className="bg-gradient-to-b from-orange-950 to-black text-ink-high py-20 px-6 text-center">
        ...
        <p className="text-ink-muted text-xs mt-4">{t('for_restaurants.bottom_note')}</p>
      </section>
