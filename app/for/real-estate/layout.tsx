...
export const metadata: Metadata = {
  ...
  description: 'Free social media scheduler for real estate agents. Schedule listing announcements on LinkedIn, cross-post to 7 platforms, and let AI generate real estate content — free forever or $8/month.',
  openGraph: {
    title: 'Social Media for Real Estate Agents — SocialMate',
  ...
  twitter: {
    ...
    title: 'Social Media for Real Estate Agents — SocialMate',
    description: 'Real estate social media scheduling. LinkedIn live. Free forever or $8/month.',
