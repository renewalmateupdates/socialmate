      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-8 max-w-md w-full text-center">
        ...
        {status === 'ready' && (
          <>
            ...
            <button
              ...
              className="w-full bg-black text-white font-bold py-3 rounded-xl hover:opacity-80 transition-all"
            >
        ...
        {status === 'error' && (
          <>
            ...
            <a href="/login" className="text-sm font-semibold text-black underline">Go to login</a>
          </>
        )}
      </div>
    </div>
