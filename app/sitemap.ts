...
const BLOG_SLUGS = [
  ...
  // Batch 14 — Automation, Hashtags, Community, Strategy, AI Tools, Growth (May 2026)
  'connect-social-media-scheduler-zapier',
  'social-media-automation-tools-solo-founders-2026',
  'how-to-use-webhooks-automate-social-media',
  'make-vs-zapier-social-media-automation',
  'auto-post-discord-when-publish-blog',
  'social-media-automation-budget-what-works',
  'hashtag-strategy-gets-reach-2026',
  'best-hashtags-linkedin-2026',
  'tiktok-hashtags-how-many-which-work',
  'save-reuse-hashtag-sets-faster-posting',
  'bluesky-hashtags-vs-twitter-hashtags',
  'schedule-posts-discord-without-bot',
  'discord-for-creators-build-community',
  'telegram-channels-vs-discord-servers-creators',
  'post-multiple-discord-servers-at-once',
  'building-creator-community-2026-discord-telegram-bluesky',
  'post-same-content-7-social-platforms',
  'cross-platform-social-media-strategy-2026',
  'why-be-on-bluesky-and-linkedin',
  'repurpose-post-tiktok-linkedin-bluesky',
  'multi-platform-social-media-calendar-consistency',
  'best-ai-writing-tools-social-media-captions-2026',
  'use-ai-write-week-social-media-posts-30-minutes',
  'ai-social-media-schedulers-vs-manual-posting',
  'how-soma-works-ai-social-content-automatically',
  'best-free-ai-tools-content-creators-2026',
  'grow-startup-social-media-zero-budget',
  'build-in-public-sharing-journey-gets-users',
  'social-media-saas-founders-drives-signups',
  'schedule-month-content-one-sitting',
  // Batch 15 — fitness, music, restaurants, real estate, nonprofits, e-commerce (May 2026)
  // Batch 16 — podcasters, coaches, bloggers, SaaS founders, creator strategy (May 2026)
  ...
  // Batch 17 — E-commerce/Etsy, Photographers, YouTubers, Freelancers, High-Intent General (May 2026)
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const core: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/guides/first-30-days-social-media`,  lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/build-your-brand-from-zero`,  lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/side-hustle-to-full-time-creator`, lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/content-creator-business`,    lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/ai-tools-for-creators-2026`,  lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/local-business-website`,      lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/email-list-building`,          lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/seo-for-beginners`,            lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    { url: `${base}/guides/reddit-marketing`,             lastModified: now, changeFrequency: 'monthly', priority: 0.9 },
    ...
    { url: `${base}/for/fitness-coaches`,   lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/for/musicians`,         lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${base}/for/nonprofits`,        lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/for/podcasters`,        lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/for/coaches`,           lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/for/content-creators`,  lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/for/bloggers`,          lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
