              ...
              <div className="bg-white border border-gray-100 rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center gap-1 px-4 py-3 border-b border-gray-100">
                  ...
                  {[
                    ...
                    <button
                      key={tool.id}
                      onClick={() => openPanel(tool.id as any)}
                ...
                <div className="px-5 py-3 border-t border-gray-100 flex items-center justify-between">
                  <div className="flex-1 mr-4">
                    <div className="w-full bg-gray-100 rounded-full h-1">
                      <div
                        className={`h-1 rounded-full transition-all ${isOver ? 'bg-red-500' : charPercent > 80 ? 'bg-orange-400' : 'bg-black'}`}
                      ...
                      return (
                        <div key={pid} className="flex items-center gap-3">
                          ...
                          <div className="flex-1 bg-gray-100 rounded-full h-1.5">
                            <div className={`h-1.5 rounded-full transition-all ${over ? 'bg-red-500' : pct > 80 ? 'bg-orange-400' : 'bg-black'}`} style={{ width: `${pct}%` }} />
                          </div>
