...
const GUIDES = [
  ...
  },
  {
    ...
    chapters: [
      ...
      'AI Discoverability — The New SEO',
    ],
  ...
  },
  {
    ...
    chapters: [
      ...
      'Banking Setup',
      'Insurance',
      'Partnerships & Joint Ventures Without Lawyers',
    ],
  ...
  },
  {
    ...
    chapters: [
      ...
      'Beyond Tips — Building Your Creator Toolkit',
    ],
    readTime: '45 min read',
  ...
  },
  {
    ...
    chapters: [
      ...
      'Automating Your First 30 Days (Without Faking It)',
    ],
  ...
  },
  {
    ...
    chapters: [
      ...
      'Finding Your Voice With AI (Without Sounding Like AI)',
    ],
    readTime: '40 min read',
  ...
  },
  {
    ...
    chapters: [
      ...
      'Letting AI Agents Run Parts of Your Business',
    ],
    readTime: '35 min read',
  ...
  },
  {
    ...
    chapters: [
      ...
      'Making Sure AI Tools Can Find and Recommend You',
    ],
    readTime: '40 min read',
  ...
  },
  {
    ...
    subtitle: 'The Audience You Own Forever',
    description:
      'Social followers can be taken from you. Email subscribers cannot. Build a real email list from nothing — the right lead magnets, a welcome sequence that converts, free tools, and how to grow from 0 to 500 subscribers before you have an audience.',
    href: '/guides/email-list-building',
    available: true,
    chapters: [
      "Why Social Followers Aren't Yours (But Email Is)",
      'The Lead Magnet (Give Something Worth Signing Up For)',
      'Your First Welcome Sequence',
      "Tools That Don't Cost Anything to Start",
      'Growing From 0 to 500 Subscribers',
      'Segmentation Without Overcomplicating It',
      'Turning Subscribers Into Customers',
      'Staying Out of Spam',
      'What Your List Tells You About What to Build',
    ],
    readTime: '30 min read',
    tags: ['Email Marketing', 'List Building', 'Growth', 'Audience'],
  },
  {
    number: 'Vol. 13',
    title: 'SEO for Normal People',
    subtitle: 'Get Found on Google Without Paying Anyone $3,000 a Month',
    description:
      "Everything the SEO industry wants you to think is complicated — explained plainly. Keyword research for free, Google Search Console setup, on-page basics, blog posts as 5-year assets, backlinks without being annoying, and local SEO vs. national SEO.",
    href: '/guides/seo-for-beginners',
    available: true,
    chapters: [
      'What Google Is Actually Looking For',
      'Keyword Research for Free',
      'Google Search Console — Your Free Scoreboard',
      'On-Page SEO in Plain English',
      'Blog Posts as 5-Year Assets',
      'The Internal Linking Game',
      'Getting Backlinks Without Being Annoying',
      'Local SEO vs. National SEO',
      'When to Hire Someone vs. Do It Yourself',
    ],
    readTime: '35 min read',
    tags: ['SEO', 'Google', 'Content Strategy', 'Organic Traffic'],
  },
  {
    number: 'Vol. 14',
    title: 'Reddit Marketing Without Getting Banned',
    subtitle: 'The Platform That Hates Spam and Rewards Real People',
    description:
      "The real Reddit playbook from someone who built a product on it: building karma, finding subreddits, posting without getting flagged, writing posts that don't sound like AI wrote them, handling trolls, and building a presence that compounds over months.",
    href: '/guides/reddit-marketing',
    available: true,
    chapters: [
      'Why Reddit Is Different From Every Other Platform',
      'Building Karma Without Being Fake',
      'Finding the Right Subreddits',
      'The Give-Before-You-Take Rule',
      'How to Post Without Getting Flagged',
      "Writing Posts That Don't Sound Like AI",
      'When and How to Mention Your Product',
      'Handling Bad Comments and Trolls',
      'Building a Long-Term Reddit Presence',
    ],
    readTime: '30 min read',
    tags: ['Reddit', 'Community Marketing', 'Growth', 'Organic'],
  },
]
