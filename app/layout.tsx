...
const jsonLd = {
  ...
  operatingSystem: 'Web',
  url: APP_URL,
  description: 'Free social media scheduling platform with AI content tools, analytics, and team collaboration. Schedule to Bluesky, Discord, Telegram, and Mastodon — more platforms coming.',
  offers: [
