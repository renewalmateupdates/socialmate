...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'i18n — full app complete',      desc: 'Settings Scheduling tab, SOMA Weekly, and SOMA Upgrade wired with useI18n(). 54 new translation keys across all 7 locale files. Full-app translation coverage now complete across all major pages.', status: 'shipped', category: 'Platform' },
