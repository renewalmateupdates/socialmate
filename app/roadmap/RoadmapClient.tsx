...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'Upgrade nudges',          desc: 'UpgradeNudge component shown in Sidebar (0/\u226410 credits), Compose (low credits on free), Settings plan tab. Dismissible 7 days via localStorage.', status: 'shipped', category: 'Growth' },
