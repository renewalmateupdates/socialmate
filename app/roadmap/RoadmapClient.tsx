...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'Full-app internationalization (i18n)', desc: 'All 12 core app pages (Dashboard, Queue, Calendar, Compose, Analytics, Accounts, Inbox, Team, Drafts, Streak, Links, Media) now translate via useI18n(). Language switcher in sidebar + public nav. Landing page correctly navigates to locale URL on language change.', status: 'shipped', category: 'Platform' },
