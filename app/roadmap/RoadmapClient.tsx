...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'Full-app internationalization (i18n)', desc: 'Translate the complete app interior — Dashboard, SOMA, Enki, Compose, Calendar, Analytics, Settings, Queue, and all ~40 app pages — into all 7 supported languages (ES, DE, FR, PT, RU, ZH). Locale switcher in sidebar. Currently only landing pages are translated.', status: 'in-progress', category: 'Platform' },
