...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'IRIS Dispatch newsletter',           desc: 'Biweekly build-in-public newsletter. Admin compose UI at /admin/iris with live preview, recipient count, and send history. CAN-SPAM compliant unsubscribe. Edition #1 sent May 2026.', status: 'shipped', category: 'Engagement' },
