...
const ROADMAP: RoadmapItem[] = [
  ...
  { title: 'HERMES cold outreach',       desc: 'Admin-only outreach tool at /hermes. Create campaigns, auto-discover prospects from Substack/GitHub/dev.to/Hashnode, generate personalized intros via Gemini, send via Resend email or Bluesky/Mastodon DM. 4-step sequences with weekly follow-up cron.', status: 'shipped', category: 'Growth' },
  { title: 'HESTIA community tab',       desc: 'Community at /community — post wins, questions, tips, and intros. Emoji reactions, threaded replies, connected-account gate. Categories: Wins / Questions / Tips / Feedback / Intros.', status: 'shipped', category: 'Engagement' },
  { title: 'SIGIL (Link in Bio)',        desc: 'Link in Bio renamed to SIGIL — consistent with SocialMate mythology naming. Same features: click analytics, QR code, custom domain on Pro+.', status: 'shipped', category: 'Platform' },
  { title: 'ZENITH creator card',        desc: 'Shareable creator presence card at /zenith. Shows platform connections, post count, streak, achievements, and top post. Social share buttons.', status: 'shipped', category: 'Platform' },
  { title: 'Achievements + 30-Day Challenge', desc: '13 achievement badges at /achievements (Posts/Streaks/Tenure/Account — unlock earns credits). 30-Day Creator Challenge at /challenge — post every day for 30 days, earn 50 credits. Daily checker cron.', status: 'shipped', category: 'Engagement' },
  { title: 'SM-Pulse + SM-Radar',        desc: 'SM-Pulse: 20-credit niche trend scanner. SM-Radar: 20-credit content intelligence report (content gaps, competitor weaknesses, best formats, timing signals). Both at /sm-pulse and /sm-radar.', status: 'shipped', category: 'AI' },
  { title: 'Post Score',                 desc: 'AI 0–100 quality scorer inline in Compose (Pro+, 5 credits). Rates hook, clarity, and engagement potential with actionable feedback.', status: 'shipped', category: 'AI' },
  { title: 'Scheduling Window + DND',    desc: 'Set your posting hours and Do-Not-Disturb window in Settings → Scheduling. Smart Queue respects your window automatically.', status: 'shipped', category: 'Scheduling' },
  { title: 'Discount page',             desc: 'NONPROFIT50 (50% off Pro) and STUDENT25 (25% off Pro with .edu). Honor system, no email verification at /discount.', status: 'shipped', category: 'Growth' },
  ...
  { title: 'Full-app internationalization (i18n)', desc: 'All core + inner app pages translate via useI18n(): Dashboard, Queue, Calendar, Compose, Analytics, Accounts, Inbox, Team, Drafts, Streak, Links, Media, AI Features, Agents, SOMA, Enki, Creator Hub, and creator public page. Language switcher in sidebar + public nav. Landing page navigates to locale URL on language change. 9 locale files (en/es/de/fr/pt/ru/zh/ja/ko) kept in sync.', status: 'shipped', category: 'Platform' },
  ...
  { title: "Gilgamesh's Guides Vol. 3",          desc: 'Business credit & legal guide at /guides/business-credit-legal — 7 chapters: DUNS, PAYDEX, licenses, tax deductions, LLC vs S-Corp, banking, and insurance for creators and founders.', status: 'shipped', category: 'Platform' },
  { title: "Gilgamesh's Guides Vol. 4",          desc: 'Vibe coding guide at /guides/vibe-coding-with-ai — 7 chapters written in Joshua\'s voice: stack, workflow, prompting, debugging, going live, and the mindset of building with no permission.', status: 'shipped', category: 'Platform' },
  { title: 'IRIS Dispatch newsletter',           desc: 'Weekly build-in-public newsletter. Admin compose UI at /admin/iris with live preview, recipient count, and send history. CAN-SPAM compliant unsubscribe. Edition #1 sent May 2026.', status: 'shipped', category: 'Engagement' },
  ...
  { title: 'SOMA video attachment',         desc: 'Add a video URL per SOMA project — injected into Gemini prompts so generated posts reference the video naturally. Cyan URL input + saved state with remove button on project page.', status: 'shipped', category: 'AI' },
  { title: 'White Label improvements',      desc: 'Full White Label settings UI — logo URL, custom brand name, primary color picker, remove-branding Pro toggle, and custom domain input. File upload to Supabase media bucket. Default accent color corrected to amber.', status: 'shipped', category: 'Platform' },
  { title: 'Enterprise tier',               desc: '/enterprise landing page with hero, feature grid, and contact form. Enterprise card on /pricing with custom pricing, unlimited seats, SLA, White Label Pro included, and dedicated onboarding. Inquiries saved to DB + emailed to admin.', status: 'shipped', category: 'Platform' },
  { title: 'SOMA Full Send daily cron',     desc: 'Full Send users get a daily 9am EDT auto-run (somaFullSendDailyRun). Max 7 posts/day per platform, 30 runs/month cap. Autopilot keeps its weekly Monday schedule. 🚀 Full Send active banner on SOMA dashboard.', status: 'shipped', category: 'AI' },
  { title: 'i18n — full parity (9 locales)', desc: 'Complete i18n parity across all 9 locales (en/es/de/fr/pt/ru/zh/ja/ko). Japanese and Korean added as full locales. All landing page sections, mobile nav labels, SM-Pulse/SM-Radar cards, and all app pages use t() with zero hardcoded English. All locale files validated in sync.', status: 'shipped', category: 'Platform' },
  { title: 'Full public site i18n (all pages)', desc: 'Every public-facing page wired with useI18n(): /pricing, /faq, /glossary, /features, all 15 /for/* audience pages, all 75 /vs/* comparison pages, /affiliates, /give, /enterprise, /community, /zenith, /discount, /challenge, /achievements, /wall-of-love, /tiktok, /monetize, /blog, /guides, /about. 74 namespaces, 9 locales. translate() supports {param} interpolation. i18n is 100% done.', status: 'shipped', category: 'Platform' },
  { title: 'SEO/AI discovery overhaul', desc: 'llms.txt expanded to 580+ lines — Preferred AI Summary block, deep per-system docs, 14 Q&A pairs, competitor comparisons. humans.txt, ai.txt, and .well-known/ai-plugin.json added. Three JSON-LD schemas in layout.tsx (SoftwareApplication, Organization, WebSite with SearchAction). SocialMate now surfaces in ChatGPT, Perplexity, Claude, and Gemini search answers.', status: 'shipped', category: 'Growth' },
  { title: 'Loading skeletons — full sweep', desc: 'Every major app route now has an instant server-rendered skeleton via loading.tsx: dashboard, onboarding, accounts, blog, features, settings, signup. Preconnect hints in layout.tsx for CDN and Supabase domains. No more blank pages during navigation.', status: 'shipped', category: 'Platform' },
  ...
  { title: 'Upgrade nudges',          desc: 'UpgradeNudge component shown in Sidebar (0 or low credits), Compose (low credits on free), Settings plan tab. Dismissible 7 days via localStorage.', status: 'shipped', category: 'Growth' },
  { title: 'Competitor post alerts',  desc: 'Push + in-app notification when a tracked competitor posts. Checks every 4 hours via Inngest cron against competitor_posts table.', status: 'shipped', category: 'Analytics' },
  ...
  { title: 'Content DNA',                desc: 'Engagement fingerprint at /analytics/dna — best day/time/length/format, top 5 posts, platform breakdown. Syncs Bluesky + Mastodon engagement on demand.', status: 'shipped', category: 'Analytics' },
  { title: 'Unified inbox + replies',    desc: 'Unified inbox at /inbox with full reply support for Bluesky and Mastodon. Inline composer on mention/reply items, 300-char counter, send confirmation.', status: 'shipped', category: 'Engagement' },
  { title: 'Compose thread builder',     desc: 'Thread mode in compose — numbered post cards, per-card char counter, auto-split, posts 30s apart. Save as Template button with title + category.', status: 'shipped', category: 'Scheduling' },
  ...
  { title: 'X (Twitter) publishing',    desc: 'X API v2 pay-per-use ($0.01/tweet) with monthly quotas (Free: 0 — Pro+ required, Pro: 150, Agency: 400). X Booster packs available for extra posts. Free users see upgrade prompt in composer.', status: 'shipped', category: 'Platforms' },
  ...
  { title: 'AI caption tools',           desc: '15+ AI tools: caption generator, hashtag generator, post rewriter, viral hook generator, thread builder, and more. All powered by Google Gemini.', status: 'shipped', category: 'AI' },
  ...
  { title: 'IRIS Dispatch newsletter',   desc: 'Weekly build-in-public newsletter at /admin/iris. CAN-SPAM compliant unsubscribe. Edition #1 sent May 14, 2026 to 29 recipients.', status: 'shipped', category: 'Growth' },
