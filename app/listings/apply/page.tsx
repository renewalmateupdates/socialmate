...
export default function ListingsApplyPage() {
        ...
        <div className="max-w-2xl mx-auto px-6 py-24 text-center">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-800 rounded-2xl p-5 mb-8 text-left">
            ...
            <ol className="space-y-1 text-xs text-amber-800 dark:text-amber-300">
              ...
              <li>2. If approved → you receive a $149/year payment link</li>
              <li>3. Pay → listing goes live immediately</li>
              <li>4. Rank higher by donating to SM-Give</li>
            </ol>
          </div>
          <Link href="/listings" className="text-sm font-bold text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
            ← Back to Listings
          </Link>
        </div>
      </PublicLayout>
  ...
  return (
    <PublicLayout>
      <div className="max-w-2xl mx-auto px-6 py-16">
        <div className="mb-8">
          <Link href="/listings" className="text-sm font-bold text-gray-400 hover:text-black dark:hover:text-white transition-all">← Back to Listings</Link>
        </div>
        <div className="mb-10">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 dark:text-gray-100 mb-2">Apply for a Listing</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
            $149/year. Founder-approved only. No corporations, no VC-backed giants — just tools built by people who actually give a damn.
          </p>
        </div>
