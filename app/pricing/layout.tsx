...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Free forever. Pro at $5/mo. Agency at $20/mo. 15+ AI tools, 7 live platforms, bulk scheduling — no credit card required to start.',
  ...
  twitter: {
    ...
    title: 'SocialMate Pricing — Free Social Media Scheduler',
    description: 'Free forever. Pro at $5/mo. Agency at $20/mo. 15+ AI tools, 7 live platforms.',
