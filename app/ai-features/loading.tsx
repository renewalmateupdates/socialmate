export default function AiFeaturesLoading() {
  return (
    <div className="flex h-screen bg-white dark:bg-gray-950">
      ...
      <div className="flex-1 overflow-auto p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[...Array(9)].map((_, i) => (
            <div key={i} className="rounded-2xl border border-gray-100 dark:border-gray-800 p-5 animate-pulse">
              <div className="w-10 h-10 rounded-xl bg-gray-100 dark:bg-gray-800 mb-3" />
              <div className="h-4 w-28 rounded bg-gray-100 dark:bg-gray-800 mb-2" />
