...
const FEATURE_CATEGORIES = [
  {
    ...
    emoji: '🤖',
    features: [
      { name: 'Caption Generator',        emoji: '✍️',  credits: '1 credit',      proOnly: false, what: 'Generates platform-optimized captions based on your topic and tone.',                                                                          how: 'Powered by Google Gemini. Analyzes your topic and platform to generate captions that match character limits, tone, and engagement patterns.' },
      { name: 'Hashtag Generator',        emoji: '#️⃣', credits: '1 credit',      proOnly: false, what: 'Generates a set of relevant, high-performing hashtags for your post.',                                                                         how: 'AI analyzes your caption content and niche to suggest hashtags that balance reach and relevance.' },
      { name: 'Post Rewrite / Improver',  emoji: '🔁',  credits: '1 credit',      proOnly: false, what: 'Takes your existing caption and makes it sharper, more engaging, and better structured.',                                                     how: 'AI rewrites for stronger hooks, better readability, and platform-appropriate tone.' },
      { name: 'Viral Hook Generator',     emoji: '🎣',  credits: '2 credits',     proOnly: false, what: 'Generates 3 scroll-stopping opening lines designed to drive clicks and engagement.',                                                          how: 'Trained on viral content patterns across TikTok, YouTube, LinkedIn and Reddit.' },
      { name: 'Thread Generator',         emoji: '🧵',  credits: '3 credits',     proOnly: false, what: 'Turns a single topic or idea into a structured multi-part thread.',                                                                           how: 'AI structures your idea into a narrative arc with a hook, supporting points, and a strong CTA.' },
      { name: 'Content Repurposer',       emoji: '♻️',  credits: '3 credits',     proOnly: false, what: 'Paste a blog post, transcript, or long caption and get platform-ready content out the other side.',                                          how: 'AI extracts key ideas from long-form content and reshapes them into short-form posts for each platform.' },
      { name: 'AI Content Calendar',      emoji: '📅',  credits: '10–20 credits', proOnly: false, what: 'Generate a full content calendar based on your niche, platforms, and posting goals.',                                                        how: 'AI plans a content strategy around your niche, then generates individual posts for each day. Fully editable before publishing. 30-day version is Pro+.' },
  ...
  },
  {
    ...
    emoji: '📡',
    features: [
      { name: 'SM-Pulse',             emoji: '🔥',  credits: '5 credits per scan',   proOnly: false, what: 'Scans social platforms to surface what is trending in your niche right now.',                                 how: 'Analyzes trending hashtags, viral post formats, and engagement spikes across Reddit, YouTube, and connected platforms. Refreshes weekly.' },
      { name: 'SM-Radar',             emoji: '📊',  credits: '3 credits per report',  proOnly: false, what: 'Analyzes your personal post performance to surface what is actually working for your audience.',              how: 'SM-Radar pulls data from your connected accounts and identifies patterns in your best-performing content — timing, format, length, and tone.' },
      { name: 'Content Gap Detector', emoji: '🕳️', credits: '2 credits',             proOnly: false, what: 'Spots gaps in your posting strategy so you never go cold on your audience.',                                  how: 'Tracks your posting history and engagement patterns, then flags when a high-performing content type has gone quiet.' },
    ],
  },
  {
    ...
    emoji: '🗓️',
    features: [
      { name: 'Bulk Scheduler',               emoji: '📦',  credits: 'Free (manual)',  proOnly: false, what: 'Schedule dozens of posts at once instead of one at a time.',                                                   how: 'Posts are queued and distributed across your selected timeframe. Manual bulk scheduling is always free.' },
